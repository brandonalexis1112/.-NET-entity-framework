...
namespace Examen.Controllers
{
    public class EspecialidadsController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "ID,especialidades")] Especialidad especialidad)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "ID,especialidades")] Especialidad especialidad)
        {
            if (ModelState.IsValid)
            {
